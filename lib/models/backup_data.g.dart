...
Map<String, dynamic> _$BackupDataToJson(
  BackupData instance,
) => <String, dynamic>{
  if (instance.customFood?.map((e) => e.toJson()).toList() case final value?)
    'customFood': value,
  if (instance.trackedFood?.map((e) => e.toJson()).toList() case final value?)
    'trackedFood': value,
  if (instance.completedDays?.map((e) => e.toIso8601String()).toList()
      case final value?)
    'completedDays': value,
  if (instance.appSettings?.toJson() case final value?) 'appSettings': value,
  if (instance.bodyTargets?.toJson() case final value?) 'bodyTargets': value,
};
