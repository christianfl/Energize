...
Map<String, dynamic> _$FoodTrackedToJson(
  FoodTracked instance,
) => <String, dynamic>{
  ...
  'dateAdded': FoodTracked._dateToMillisecondsSinceEpoch(instance.dateAdded),
  'dateEaten': FoodTracked._dateToMillisecondsSinceEpoch(instance.dateEaten),
